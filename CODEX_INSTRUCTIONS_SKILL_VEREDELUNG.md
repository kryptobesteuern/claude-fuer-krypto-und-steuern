...
1. **Bestandsaufnahme.** Bestehende `SKILL.md` vollstaendig lesen.
   ...
   Quellenlage (Normen, BMF-Schreiben, Rechtsprechungs-Anker) aktuell?
2. **Luecken identifizieren.** Fehlen Beispiele? Ist die Checkliste zu
   grob? Fehlt ein Rechtsstand-Datum?
3. **Ueberarbeiten, nicht ersetzen.** Bestehende korrekte Inhalte
   ...
   im PR-Text.
4. **Quellenpruefung.** Jede neu eingefuegte Norm-, Schreiben- oder
   Urteilsangabe gegen `references/zitierweise-krypto.md` pruefen.
