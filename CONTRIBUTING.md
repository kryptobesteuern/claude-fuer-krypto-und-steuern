...
- [ ] Zitierweise nach `references/zitierweise-krypto.md` eingehalten.
- [ ] Methodik nach `references/methodik-krypto-steuerrecht.md` eingehalten.
...
- [ ] Keine echten Mandanten-, Wallet- oder Kontodaten, keine privaten
      Schluessel.
