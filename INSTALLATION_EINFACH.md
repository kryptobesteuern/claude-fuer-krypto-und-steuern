...
2. Einen einfachen, fiktiven Beispielfall (z. B. "Kauf von 0.1 BTC am
   1. Januar 2024, Verkauf am 1. Maerz 2024") mit dem Skill
   `btc-eth-einkunftsart-23-estg` pruefen lassen.
3. Pruefen, ob die Ausgabe einen Disclaimer und ein Rechtsstand-Datum
   enthaelt.
